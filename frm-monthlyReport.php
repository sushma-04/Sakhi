...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">तारखेनुसार - दैनंदिन अहवाल यादी</h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="" style="overflow-x: auto;">
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        <label for="selectedDate" class="form-label">तारीख निवडा </label>
                                        <input type="date" name="date" class="form-control" id="selectedDate" required>
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-md-3">
    ...
    <script src="./assets/js/filter/monthlyReportList.js"></script>
    ...
    <script>
        ...
        const setClusterDropdown = async (blockCode, selectedCluster) => {
            ...
            const { data } = await addressApi.getCluster(blockCode);
        ...
        async function getAllAnswersByClusterParams() {
            ...
            monthlyReportList(stateCode, districtCode, blockCode, clusterId, selectedDate);
        }
    </script>
    <script>
