...
<head>
    ...
    <title>Bank सखी मासिक अहवाल यादी</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0" id="name_upade">बँक सखी मूल्यांकन </h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="./assets/js/filter/bankSakhiQuestion.js"></script>
    <script src="assets/js/parseData.js"></script>
    <script src="assets/js/filter/updateBankSakhi.js"></script>
