...
<head>
    ...
    <title>समुदाय स्थरीय प्रशिक्षण सल्लगार सखी मूल्यांकन</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0" id="name_upade">समुदाय स्थरीय प्रशिक्षण सल्लगार सखी मूल्यांकन </h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="./assets/js/filter/CTCQuestions.js"></script>
    <script src="assets/js/parseData.js"></script>
    <script src="assets/js/filter/updateCTCahwal.js"></script>
    <script>
        CTCQuestions();
        // CTCAnswers();
