...
<head>
    ...
    <title>पशु सखी मासिक अहवाल यादी</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">पशु सखी मासिक अहवाल यादी</h1>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="" style="overflow-x: auto;">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody id="pashuSakhiReportsList">
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
    ...
    <script src="./assets/js/filter/listPashuSakhi.js"></script>
    ...
    //     const selectedClusterId = selectedOption.value;
    //     const selectedClusterName = selectedOption.innerText;
    //     console.log("Selected Cluster ID:", selectedClusterId);
    //     console.log("Selected Cluster Name:", selectedClusterName);
    // });
    //         };
    //     });
    ...
    <script>
        ...
        async function getAllAnswersByClusterParams() {
            ...
            if (!stateCode && !districtCode && !blockCode && !clusterId) {
                ListAllPashuSakhiReport();
            } else {
                ListPashuSakhiReport(stateCode, districtCode, blockCode, clusterId);
            }
        }
        ...
        //     // Now you can call the original function with these parameters
        //     ListPashuSakhiReport(stateCode, districtCode, blockCode, clusterId);
        // }
    </script>
