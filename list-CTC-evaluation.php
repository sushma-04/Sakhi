...
<head>
    ...
    <title>समुदाय स्थरीय प्रशिक्षण सल्लगार मूल्यांकन</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">समुदाय स्थरीय प्रशिक्षण सल्लगार मासिक अहवाल यादी</h1>
                        </div>
    ...
    <script src='./assets/js/filter/listCTCEvaluation.js'></script>
    ...
    <script>
        ...
        //     ListCTCReport(stateCode, districtCode, blockCode, clusterId);
        // }
