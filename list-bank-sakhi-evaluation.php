...
<head>
    ...
    <title>बँक सखी मासिक अहवाल यादी</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">बँक सखी मासिक अहवाल यादी</h1>
                        </div>
    ...
    <script src='./assets/js/filter/listBankSakhiEvaluation.js'></script>
    ...
    <script>
        ...
        //     ListBankSakhiReport(stateCode, districtCode, blockCode, clusterId);
        // }
        $(function() {
            $("#example1").DataTable({
                "responsive": true,
